        ...
        <div className=" fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className=" relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8 ">
            ...
            <button
              ...
              className=" absolute top-6 right-6 w-8 h-8 flex items-cente justify-center rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-all duration-200"
            >
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center py-10 px-6">
                    <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4"
                      ...
                      <Upload
                        className="w-7 h-7"
                        style={{ color: "var(--btn-primary-from)" }}
                        strokeWidth={2}
                      />
                    </div>
                    <p className="text-sm font-medium mb-1" style={{ color: "var(--text-secondary)" }}>
                      {uploadFile ? (
                        <span style={{ color: "var(--btn-primary-from)" }}>
                          {uploadFile.name}
                        </span>
                      ) : (
                        <>
